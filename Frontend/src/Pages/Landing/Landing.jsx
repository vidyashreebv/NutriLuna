...
import "./Landing.css"; // Assuming styles are moved to a separate CSS file
...
function Landing() {
  ...
  const data = [
    ...
    // Other data entries can be added here if needed
  ];
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      gsap.to("nav", { y: 0, opacity: 1, ease, delay: 0.5 });
    ...
    document.querySelector(".arrow-left").addEventListener("click", () => {
      clicks = 1; // Set clicks to 1 to trigger the step function
      step();
    });

    document.querySelector(".arrow-right").addEventListener("click", () => {
      clicks = 1; // Set clicks to 1 to trigger the step function
      order.push(order.shift()); // Move the first element to the end
      step(); // Call step function to update the display
    });
    // Add event listener for the "Get Started" button
    document.getElementById("getstarted").addEventListener("click", () => {
      window.location.href = "/login"; // Redirect to the signin page
    });
    document.getElementById("getstarted1").addEventListener("click", () => {
      window.location.href = "/login"; // Redirect to the signin page
    });
    start();
    // Remove the invalid bracket here

    // ... (rest of the JavaScript code as in the original script)
    ...
    <div>
      ...
      <div className="details" id="details-even">
        ...
        <div className="cta">
          ...
          <button className="discover" id="getstarted">Get Started!</button>
        </div>
      </div>
      <div className="details" id="details-odd">
        ...
        <div className="cta">
          <button className="discover" id="getstarted1">Get Started!</button>
        </div>
      </div>
